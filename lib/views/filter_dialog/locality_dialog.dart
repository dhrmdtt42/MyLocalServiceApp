...
import 'package:haarway_app/views/filter_dialog/allcheck_items/locality_check_items.dart';
...
class LocalityCustomDialogBox extends StatefulWidget {
...
//      this.sortBy
  ...
  @override
  _LocalityCustomDialogBoxState createState() =>
      _LocalityCustomDialogBoxState();
}

class _LocalityCustomDialogBoxState extends State<LocalityCustomDialogBox> {
              ...
              Container(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      LocalityFilterData loData = widget.localities[index];
                      String title = loData.locality;
                      return CheckLocalityItems(
                          index: index,
