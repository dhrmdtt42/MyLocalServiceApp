...
class RequestItemCatPage extends StatefulWidget {
  final String seoUrl;
  final String customerID;
  final String rating;
  final VoidCallback callbackRequestItem;

  RequestItemCatPage(
      {@required this.seoUrl,
      @required this.customerID,
      @required this.rating,
      @required this.callbackRequestItem});

  @override
  _RequestItemCatPageState createState() => _RequestItemCatPageState();
}

class _RequestItemCatPageState extends State<RequestItemCatPage> {
                      ...
                      child: RaisedButton(
                        onPressed: () {
                          ...
                          if (rTitle != null &&
                            ...
                            reviewRequest.reviewRating = widget.rating;
