...
class RequestItemOtp extends StatefulWidget {
  final String email;
  final String newEmail;
  final bool isGuestCheckOut;

  const RequestItemOtp({
    Key key,
    @required this.email,
    this.newEmail = "",
  ...
  @override
  _RequestItemOtpState createState() => new _RequestItemOtpState();
}

class _RequestItemOtpState extends State<RequestItemOtp>
    ...
    setState(() {
      ...
      if (_firstDigit == null) {
        ...
        Provider.of<ProviderModel>(context, listen: false)
            .requestItemOtpVerify(otp, context, global.requestItem_otp_id);
