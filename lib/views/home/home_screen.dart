...
//    userLocation.currentAddress = "";
    ...
    print("allDataFlow : $allDataFlag");
    if (getFlagResult() == false) {
      return Scaffold(
        body: Container(
                            ...
                            images: [
                              GridView.count(
                                  ...
                                  children: List.generate(
                                    ...
                                    mainCategoryData = mainCategoryList[index];
                                    String iconUrl =
              ...
              Container(
                ...
                child: popularCategoryList == null
                    ...
                    : ListView.builder(
                        ...
                        scrollDirection: Axis.horizontal,
                        itemBuilder: (BuildContext context, int index) {
                          popularCategoryDataItem = popularCategoryList[index];
                          String imageUrl =
                              popularCategoryDataItem.category_image;
                          String title = popularCategoryDataItem.category_title;
                ...
                child: eventPartyList == null
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          String imageUrl = eventPartyDataItem.category_image;
                ...
                child: homeImprovementList == null
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          String imageUrl = homeImprovementData.category_image;
                ...
                child: educationJobsDataList == null
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          String imageUrl = educationJobsData.category_image;
                ...
                child: trendingServicesDataList == null
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          String imageUrl = trendingServicesData.category_image;
                          String title = trendingServicesData.category_title;
                ...
                child: homeofficesDatalist == null
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          String imageUrl = homeOfficeDataModel.category_image;
                          String title = homeOfficeDataModel.category_title;
                          seo_url7 = homeOfficeDataModel.seo_url;
                          print("home Office seo Url============::: $seo_url7");
                ...
                child: healthCareDataList == null
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          String imageUrl = healthCareDataItem.category_image;
