class HomeOfficeDataModel {
  String homeandoffice_categoryID;
  String parentID;
  ...
  factory HomeOfficeDataModel.fromJson(Map<String, dynamic> homeJson) {
    return HomeOfficeDataModel(
        homeandoffice_categoryID: homeJson['homeandoffice_categoryID'],
